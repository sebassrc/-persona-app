...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <form action="{{ route('paises.update', ['pais' => $pais->pais_codi]) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nombre" name="nombre" value="{{ $pais->pais_nomb }}">
            </div>
            <div class="mb-3">
                <label for="capital" class="form-label">Capital del País</label>
                <input type="text" class="form-control" id="capital" name="capital" value="{{ $pais->pais_capi }}">
            </div>
